...
namespace Elevation
{
    ...
    public class Pillar : TerrainFeature
    {
        private static int minElevationTier = 3;
        public static MinMax radius = new MinMax(2, 5);
        public static MinMax mutation = new MinMax(0, 2);
