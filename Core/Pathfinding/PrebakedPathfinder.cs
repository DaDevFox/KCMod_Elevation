...
//    public class PrebakedPathfinder_improved : ElevationPathfinder
//    {
...
//                    CellMeta[] neighbors = meta.neighborsPlusFast;
...
//                        int difference = Math.Abs(meta.elevationTier - neighbor.elevationTier);
...
//            {
//                h = PrebakedPathfinder_improved.Dist(cell.Center.xz(), other.cell.Center.xz());
//                return h;
//            }
